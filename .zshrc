...
alias airflow_local="docker exec -it data-pipelines-webserver-1 bash"
alias compile="python ~/data-pipelines/scripts/dbt_performance_measurement.py dbt-compile-measurement"
